        ...
        <div className="header-desktop">
            <navbar>
                <div className="contenedor-logo">
                    <Link to="/" className="a-logo">
                        <img className="img-logo" src="https://doraemon.lukinternacional.com/img/doraemon-logo-1612528256.jpg" alt="Logo de Doraemon" />
                    </Link>
                </div>
                ...
                <div className="contenedor-categorias">
                    ...
                    <div className="categoria">
                        <Link to={"/categoria/LotesExclusivos"} className="categoria-texto">LOTES EXCLUSIVOS</Link>
                    </div>
                    <div className="categoria">
                ...
                <div className="contenedor-busqueda">
                    <div className="idioma">
                        <a href="#">
                            <div className="contenedor-idiomas">
                                <svg className="icon" class="lang__icon fill-current text-primary-300" stroke="none" width="8.844" fill="#009FE3" height="5.358">
                    ...
                    <div className="busqueda">
                        ...
                        <div className="con-lupa" onClick={redirectToProduct}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-current w-6 h-6 md:w-5 md:h-5 text-primary-300" width="20" height="20" fill="#009FE3" viewBox="0 0 22.4 22.4" overflow="visible">
                    ...
                    <div className="carrito-login">
                        <div className="caja" >
                            <svg id="lupita" onClick={() => setActiveSearch(true)} style={{ display: "none" }} xmlns="http://www.w3.org/2000/svg" class="fill-current w-6 h-6 md:w-5 md:h-5 text-primary-300" width="22.7" height="22.8" fill="#009FE3" viewBox="0 0 22.4 22.4" overflow="visible">
                                <path className="lupp" d="M22.4 21l-4.8-4.8c1.4-1.7 2.2-3.9 2.2-6.3 0-5.5-4.4-9.9-9.9-9.9S0 4.4 0 9.9s4.4 9.9 9.9 9.9c2.4 0 4.5-.8 6.3-2.2l4.8 4.8 1.4-1.4zM9.9 17.8C5.5 17.8 2 14.3 2 9.9S5.5 2 9.9 2s7.9 3.5 7.9 7.9-3.5 7.9-7.9 7.9z"></path>
                            </svg>
                        </div>
                        <div className="caja">
                            <Link to={"/login"}>
                                <svg className="carrito-login-icon" xmlns="http>//www.w3.org/2000/svg" width="22.7" height="22.8" overflow="visible" fill="#009FE3">
                        ...
                        <div className="caja">
                            <Link to={"/checkout"}>
                                <svg className="carrito-login-icon" xmlns="http://www.w3.org/2000/svg" class="fill-current text-primary-300 w-6 h-6" width="22.1" height="23.6" overflow="visible" fill="#009FE3">
                        ...
                        <div className="caja" onClick={() => setActiveSidebar(true)}>
                            <svg id="hamburguesa" style={{ display: "none", cursor: "pointer" }} width="32" height="32" color="#009FE3" class="text-primary-300 w-8 h-8" viewBox="0 0 32 32" stroke="currentcolor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div className="sidebar" style={{ display: activeSidebar ? "block" : "none" }} >
                    ...
                    <div className="all">
                        <div className="abrir-cerrar">
                            ...
                            <div className="contenedor-icon-x" onClick={() => setActiveSidebar(false)}>
                                <svg className="icon" width="24" height="24" color="#FFFFFF" class="text-primary-300 w-8 h-8" viewBox="0 0 32 32" stroke="currentcolor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <div className="categoria">
                            <div className="categoria-nombre">
                                <div className="contenedor-texto-icon" onClick={() => handleCategoria("juguetes")}>
                                    <div className="con-texto">
                                        <p className="texto">JUGUETES</p>
                                    </div>
                                    <div className="con-icon" style={getConditionalStyle("juguetes")} >
                                        <svg class="menuDown icon fill-current text-white w-4 h-4" stroke="none" viewBox="0 0 24 24" fill="#FFFFFF" width="18" height="18">
                                ...
                                <div className="contenedor-articulos" style={{ display: activeCategoria.juguetes ? "block" : "none" }} >
                                    <div className="articulos">
                                        <Link to={"/categoria/Peluche"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">PELUCHES</p>
                                        </Link>
                                        <Link to={"/categoria/Juego"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">JUEGOS</p>
                                        </Link>
                                        <Link to={"/categoria/Figura"} onClick={() => setActiveSidebar(false)}>
                                ...
                                <div className="contenedor-texto-icon" onClick={() => handleCategoria("peliculas")}>
                                    <div className="con-texto">
                                        <p className="texto">PELÍCULA</p>
                                    </div>
                                    <div className="con-icon" style={getConditionalStyle("peliculas")} >
                                        <svg class="menuDown icon fill-current text-white w-4 h-4" stroke="none" viewBox="0 0 24 24" fill="#FFFFFF" width="18" height="18">
                                            <path d="M12 16.7L1.2 5.9c-.3-.3-.7-.3-1 0s-.3.7 0 1l11.3 11.3c.3.3.7.3 1 0L23.8 6.8c.1-.1.2-.3.2-.5s-.1-.3-.2-.4c-.3-.3-.7-.3-1 0L12 16.7z"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div className="contenedor-articulos" style={{ display: activeCategoria.peliculas ? "block" : "none" }} >
                                    <div className="articulos">
                                        <Link to={"/categoria/DVD"} onClick={() => setActiveSidebar(false)}></Link>
                                        <p className="texto">DVD</p>
                                        <Link to={"/categoria/BLURAY"} onClick={() => setActiveSidebar(false)}>
                                ...
                                <div className="contenedor-texto-icon" onClick={() => handleCategoria("escolar")}>
                                    <div className="con-texto">
                                        <p className="texto">ESCOLAR Y PAPELERÍA</p>
                                    </div>
                                    <div className="con-icon" style={getConditionalStyle("escolar")} >
                                        <svg class="menuDown icon fill-current text-white w-4 h-4" stroke="none" viewBox="0 0 24 24" fill="#FFFFFF" width="18" height="18">
                                            <path d="M12 16.7L1.2 5.9c-.3-.3-.7-.3-1 0s-.3.7 0 1l11.3 11.3c.3.3.7.3 1 0L23.8 6.8c.1-.1.2-.3.2-.5s-.1-.3-.2-.4c-.3-.3-.7-.3-1 0L12 16.7z"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div className="contenedor-articulos" style={{ display: activeCategoria.escolar ? "block" : "none" }} >
                                    <div className="articulos">
                                        <Link to={"/categoria/MaterialEscolar"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">MATERIAL ESCOLAR</p>
                                        </Link>
                                        <Link to={"/categoria/Mochila"} onClick={() => setActiveSidebar(false)}>
                                ...
                                <div className="contenedor-texto-icon" onClick={() => handleCategoria("moda")}>
                                    <div className="con-texto">
                                ...
                                <div className="contenedor-articulos" style={{ display: activeCategoria.moda ? "block" : "none" }} >
                                    <div className="articulos">
                                        <Link to={"/categoria/Ropa"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">ROPA</p>
                                        </Link>
                                        <Link to={"/categoria/Accesorios"} onClick={() => setActiveSidebar(false)}>
                                ...
                                <div className="contenedor-texto-icon" onClick={() => handleCategoria("hogar")}>
                                    <div className="con-texto">
                                        <p className="texto">HOGAR</p>
                                    </div>
                                    <div className="con-icon" style={getConditionalStyle("hogar")} >
                                        <svg class="menuDown icon fill-current text-white w-4 h-4" stroke="none" viewBox="0 0 24 24" fill="#FFFFFF" width="18" height="18">
                                            <path d="M12 16.7L1.2 5.9c-.3-.3-.7-.3-1 0s-.3.7 0 1l11.3 11.3c.3.3.7.3 1 0L23.8 6.8c.1-.1.2-.3.2-.5s-.1-.3-.2-.4c-.3-.3-.7-.3-1 0L12 16.7z"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div className="contenedor-articulos" style={{ display: activeCategoria.hogar ? "block" : "none" }} >
                                    <div className="articulos">
                                        <Link to={"/categoria/RopaCama"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">ROPA DE CAMA</p>
                                        </Link>
                                        <Link to={"/categoria/Taza"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">TAZAS Y VAJILLA</p>
                                        </Link>
                                        <Link to={"/categoria/Baño"} onClick={() => setActiveSidebar(false)}>
                                ...
                                <div className="contenedor-texto-icon">
                                    <div className="con-texto">
                                        <Link to={"/categoria/LotesExclusivos"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">LOTES EXCLUSIVOS</p>
                                        </Link>
                                    </div>
                                </div>
                                <div className="contenedor-texto-icon" onClick={() => handleCategoria("regalos")}>
                                    <div className="con-texto">
                                        <p className="texto">REGALOS</p>
                                    </div>
                                    <div className="con-icon" style={getConditionalStyle("regalos")} >
                                        <svg class="menuDown icon fill-current text-white w-4 h-4" stroke="none" viewBox="0 0 24 24" fill="#FFFFFF" width="18" height="18">
                                            <path d="M12 16.7L1.2 5.9c-.3-.3-.7-.3-1 0s-.3.7 0 1l11.3 11.3c.3.3.7.3 1 0L23.8 6.8c.1-.1.2-.3.2-.5s-.1-.3-.2-.4c-.3-.3-.7-.3-1 0L12 16.7z"></path>
                                        </svg>
                                    </div>
                                </div>
                                <div className="contenedor-articulos" style={{ display: activeCategoria.regalos ? "block" : "none" }} >
                                    <div className="articulos">
                                        <Link to={"/categoria/DE 1 A 3 AÑOS"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">DE 1 A 3 AÑOS</p>
                                        </Link>
                                        <Link to={"/categoria/DE 3 A 5 AÑOS"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">DE 3 A 5 AÑOS</p>
                                        </Link>
                                        <Link to={"/categoria/DE 5 A 8 AÑOS"} onClick={() => setActiveSidebar(false)}>
                                            <p className="texto">DE 5 A 8 AÑOS</p>
                                        </Link>
                                        <Link to={"/categoria/DE 8 A 11 AÑOS"} onClick={() => setActiveSidebar(false)}>
            ...
            <div className="fondo-buscador" style={{ display: activeSearch ? "block" : "none" }}>
                ...
                <div className="icon-x" onClick={() => setActiveSearch(false)}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" class="md:hidden fill-current text-white ml-auto mb-2 mr-3" id="searchClose" width="22.2" height="22.2" viewBox="0 0 22.2 22.2" overflow="visible"><defs></defs>
