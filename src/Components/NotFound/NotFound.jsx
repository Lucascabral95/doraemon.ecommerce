                ...
                <div className="contenedor-not-found">
                    <div className="cont">
                        <div className="imagen">
                            <img src="/img/doraemon-asustado.png" alt="Doraemon sorprendido" />
                        </div>
                        <div className="texto-not-found">
                            <h3 className="titulo-not-found"> 404 </h3>
                            <span className="subtitulo-not-found"> La página que buscas no se ha encontrado. </span>
                            <span className="texto"> Realiza una nueva búsqueda sobre tu interés </span>
