                ...
                <div className="filtro-card">
                    <div className="filtro">
                        <div className="filtro-div">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="fill-current ml-2" width="9" height="5.56" viewBox="0 0 9 5.56">
                                    ...
                                    <div className="contenedor-card" key={index}>
                                        <div className="imagen-cart">
                                            <div className="icono" onClick={() => mostrarID(item.id)}>
                                                <svg fill="#009FE3" xmlns="http://www.w3.org/2000/svg" className="fill-current" width="22.1" height="23.6" viewBox="0 0 22.1 23.6" overflow="visible"><path className="st0" d="M6.5 22.6c-1.8 0-3.2-1.4-3.2-3.2s1.4-3.2 3.2-3.2c1.8 0 3.2 1.4 3.2 3.2s-1.4 3.2-3.2 3.2zm0-4.4c-.7 0-1.2.5-1.2 1.2s.5 1.2 1.2 1.2 1.2-.5 1.2-1.2-.5-1.2-1.2-1.2z" id="Elipse_55_1_"></path><path className="st0" d="M18.8 22.6c-1.8 0-3.2-1.4-3.2-3.2s1.4-3.2 3.2-3.2c1.8 0 3.2 1.4 3.2 3.2s-1.4 3.2-3.2 3.2zm0-4.4c-.7 0-1.2.5-1.2 1.2s.5 1.2 1.2 1.2 1.2-.5 1.2-1.2-.5-1.2-1.2-1.2z" id="Elipse_56_1_"></path><path className="st0" d="M20.4 15.4H4.2L2 1H0v-2h3.8l.5 3.6h17.8l-1.7 12.8zM6 13.4h12.7l1.2-8.8H4.6L6 13.4z"></path>
                                                </svg>
                                            </div>
                    ...
                    <div className="botones-de-paginacion">
                        <svg style={{ display: currentPage === 1 ? "none" : "block" }} xmlns="http://www.w3.org/2000/svg" className="pagination__link w-4 h-4 fill-current" width="6.6" height="11.7" viewBox="0 0 6.6 11.7" overflow="visible">
                            <path fill="#4d4d4d" d="M5.854.036l.7.7-5.1 5.1 5.1 5.1-.7.8-5.9-5.9z">
                            </path>
                        </svg>
                        {paginacion}
                        <svg style={{ display: currentPage === cantidadPaginas ? "none" : "block" }} xmlns="http://www.w3.org/2000/svg" className="pagination__link w-4 h-4 fill-current" width="6.6" height="11.7" viewBox="0 0 6.6 11.7" overflow="visible">
