        ...
        <div className="footer">
            ...
            <div className="productos">
                    ...
                    <div className="seccion">
                        ...
                        <ul className="contenido">
                            ...
                            <div className="icon-texto">
                                <svg xmlns="http://www.w3.org/2000/svg" className="fill-current text-primary-300 hover:text-priamry-500 mr-2" width="14.7" height="14.7" viewBox="0 0 14.7 14.7" overflow="visible"><defs></defs>
                            ...
                            <div className="icon-texto">
                                <svg xmlns="http://www.w3.org/2000/svg" className="fill-current text-primary-300 hover:text-priamry-500 mr-2" width="15.2" height="15.7" viewBox="0 0 15.2 15.7" overflow="visible">
                ...
                <div className="iconos-redes-sociales">
                    <div className="icono">
                        <svg width="20" height="20" className="fill-current text-primary-300 hover:text-primary-500 w-5 h-5 youtube" stroke="none" viewBox="0 0 32 32">
                    ...
                    <div className="icono">
                        <svg width="20" height="20" className="fill-current text-primary-300 hover:text-primary-500 w-5 h-5 instagram" stroke="none" viewBox="0 0 32 32">
                    ...
                    <div className="icono">
                        <svg width="20" height="20" className="fill-current text-primary-300 hover:text-primary-500 w-5 h-5 facebook" stroke="none" viewBox="0 0 32 32">
                    ...
                    <div className="icono">
                        <svg width="20" height="20" className="fill-current text-primary-300 hover:text-primary-500 w-5 h-5 twitter" stroke="none" viewBox="0 0 32 32">
